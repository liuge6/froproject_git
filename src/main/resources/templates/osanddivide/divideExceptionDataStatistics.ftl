...
<div class="left f-left">
    <ul class="left-ul">
        <li class="left-ul-li" txt="分成异常统计" onclick="showInfo('分成异常统计')">分成异常统计</li>
        ...
        <li class="left-ul-li" txt="造异常页面" onclick="showInfo('仓库信息配置')">造异常页面</li>
        <li class="left-ul-li" txt="科目设置组配置" onclick="showInfo('仓库信息配置')">科目设置组配置</li>
...
<div class="right f-left" >
    ...
    <#--新增按钮-->
    <div class="add-btn">
        <div class="layui-btn layui-btn-sm" onclick="addData()" id="insertData">新增</div>
    </div>

    <#--展示模型折线图饼图-->
    <div class="show-model">
        <div class="show-bar-left" id="showBar"  style="width: 50%;height:400px;">

        </div>

        <div class="show-pie-right" id="showPie" style="width: 50%;height:400px;">
    ...
    <#--折线图展示-->
    <div class="show-line" id="showLine" style="width: 100%;height:400px;">
...
<#--<script>
    function addData() {
            ...
            var layer = layui.layer;
                ...
                area : [ '480px','500px' ], // 只设置宽度 如果要设置宽度、高度： ['500px','300px']
    ...
    function addData() {
        layui.use("layer", function() {
            ...
            layer.open({
                type : 1,
                skin : 'layui-layer-molv',
                area : [ '480px','380px' ], // 只设置宽度 如果要设置宽度、高度： ['500px','300px']
                content : $("#exceptionDataAddDiv"), // 这里content是一个html
                title : "新增异常展示",
                btn : [ '保存', '取消' ],
                yes : function(index, layero) {
